 ...
 */
final class Version20240222233443 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE quote ADD guid UUID NOT NULL');
        $this->addSql('ALTER TABLE quote ADD tva DOUBLE PRECISION NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE quote DROP guid');
        $this->addSql('ALTER TABLE quote DROP tva');
